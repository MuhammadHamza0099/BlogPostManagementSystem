...
public class PaginatedResult<T> : Result
{
    ...
    internal PaginatedResult(bool succeeded, string message, List<string> errors, T data = default, int pageNumber = 1, int pageSize = 10, int totalRecords = 0)
    {
        Succeeded = succeeded;
        Message = message;
        Errors = errors;
    ...
    public static PaginatedResult<T> Failure(string message, List<string> errrors)
    {
